...
#Funcion MANIPULA
  ...
  def _GetStatusError(self,st,er):
    ...
    if   (st & 0x6A) == 0x6A: #En modo fiscal, carga completa de la memoria fiscal y emision de documentos no fiscales
      self.status='En modo fiscal, carga completa de la memoria fiscal y emision de documentos no fiscales'
      status = "12"
    elif (st & 0x69) == 0x69: #En modo fiscal, carga completa de la memoria fiscal y emision de documentos  fiscales
      ...
      status = "10"
    elif (st & 0x72) == 0x72: #En modo fiscal, cercana carga completa de la memoria fiscal y en emision de documentos no fiscales
      self.status='En modo fiscal, cercana carga completa de la memoria fiscal y en emision de documentos no fiscales'
      status = "9 "
    elif (st & 0x71) == 0x71: #En modo fiscal, cercana carga completa de la memoria fiscal y en emision de documentos no fiscales
      self.status='En modo fiscal, cercana carga completa de la memoria fiscal y en emision de documentos no fiscales'
      status = "8 "
      ...
      status = "7 "
    elif (st & 0x62) == 0x62: #En modo fiscal y en emision de documentos no fiscales
      self.status='En modo fiscal y en emision de documentos no fiscales'
      status = "6 "
    elif (st & 0x61) == 0x61: #En modo fiscal y en emision de documentos fiscales
      ...
      status = "4 "
    elif (st & 0x42) == 0x42: #En modo prueba y en emision de documentos no fiscales
      self.status='En modo prueba y en emision de documentos no fiscales'
      status = "3 "
    elif (st & 0x41) == 0x41: #En modo prueba y en emision de documentos fiscales
    ...
    if   (er & 0x6C) == 0x6C: #Memoria Fiscal llena
      ...
      error = "80 "
    elif (er & 0x43) == 0x43: #Fin en la entrega de papel y error mecanico
      self.error = 'Fin en la entrega de papel y error mecanico'
      error = "3  "
