...
class ReportSaleDetails(models.AbstractModel):
    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False):
        ...
        total_costo_usd = round((total_costo_bsf * rate_usd), decimales)

        return {
            'currency_precision': user_currency.decimal_places,
            'total_paid': user_currency.round(total),
            'total_paid_usd': round((user_currency.round(total) * rate_usd), decimales),
            ...
            'margen_usd': calcular_margen(total_costo_usd, (user_currency.round(total) * rate_usd), False),
